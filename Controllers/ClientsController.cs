...
namespace FormRegistrator.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            switch (sortOrder)
            {
                case "name_desc":
                    ...
                    break;
                case "Date":
                    clients = clients.OrderBy(s => s.RegistrationDate);
                    break;
                case "date_desc":
                    clients = clients.OrderByDescending(s => s.RegistrationDate);
                    break;
        ...
        public ActionResult Create([Bind(Include = "LastName, FirstMidName, RegistrationDate, Position, Organisation, Email")]Client client)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(clientToUpdate, "",
               new string[] { "LastName", "FirstMidName", "RegistrationDate", "Position", "Organization", "Email" }))
            {
                try
                {
                    db.SaveChanges();
